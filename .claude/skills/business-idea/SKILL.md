---
name: business-idea
description: "心理学的テクニックを用いた対話形式で、ひとことのメモや漠然としたビジョンからビジネスアイデアを共創・発展させ、最終的にMD形式の企画書（核心コンセプト・価値提案・競合分析・エンゲージメント設計・ビジネスの可能性）にまとめる。「ビジネスアイデアを考えたい」「アイデアを一緒に発展させて」「事業アイデアを企画書にして」等で使用。"
---
...
7. **競合克服の戦略化**: 競合の強み・弱みを分析し、勝てるポジションを見つけます
8. **継続利用の仕組み設計**: ユーザーが使い続けたくなる習慣ループや報酬設計を探ります
...
7. **競合との差別化深掘り**: 「既存の解決策の不満は？」「競合にできないことは？」と掘り下げます
8. **習慣と報酬の設計**: 「どんな瞬間にまた使いたくなるか？」「続けることで何が積み上がるか？」を探ります
...
## 4. 競合分析と勝ち筋
[主要な競合・代替手段の強み/弱みと、それを上回る戦略]

## 5. 使い続けたくなる仕組み（エンゲージメント設計）
[習慣ループ・報酬設計・ネットワーク効果・スイッチングコストなど、
 ユーザーが離脱せず継続的に利用する仕組み]
...
- 元プロンプト（詳細確認用）: `workflows/business-planning/business-idea.md`
- 次ステップ（品質レビュー）: `review-business-idea` skill
- 次ステップ（事業計画書化）: `business-proposal` skill
