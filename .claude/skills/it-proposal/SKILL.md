---
name: it-proposal
description: "IT系システム開発の企画書を「機能」ではなく「本質的な体験価値」（感情的・心理的な価値、希少性、継続性、習慣化）中心に作成する。企画タイトル・体験価値・ターゲット市場等の入力から、体験価値の測定・エンゲージメント/リテンション設計・競合の体験価値比較・モート分析までを含む完全な企画書（MD形式）を生成する。「IT企画書を体験価値重視で書きたい」「システム開発の提案書を作って」「機能でなく体験で語る企画書」等で使用。"
---
...
**5. 体験価値の習慣化と離脱防止**
- ユーザーはその体験をどのくらいの頻度で求めますか？毎日？毎週？
- 使い続けるほどユーザーにとって価値が増す仕組みはありますか？（データ蓄積・カスタマイズ・人間関係等）
- ユーザーが離脱したくなくなる「投資」は何ですか？
- 競合に乗り換えた場合、ユーザーが失うものは何ですか？

**6. 競合の体験価値に対する勝ち筋**
- 競合が提供している体験価値の限界は何ですか？
- 競合の強みを無力化する方法はありますか？
- あなたのサービスだけが提供できる体験の「独占的要素」は何ですか？
...
## 4.5+ エンゲージメント・リテンション設計

### 4.6 習慣ループと行動設計

[ユーザーが体験価値を繰り返し求めるようになるための行動設計。]

| 要素 | 設計内容 |
|------|----------|
| **トリガー（きっかけ）** | [外的トリガー（通知・メール等）と内的トリガー（感情・習慣）の設計] |
| **アクション（行動）** | [ユーザーが取る最小限の行動。摩擦の最小化] |
| **変動報酬** | [予測不可能な報酬による期待感：達成報酬・社会的報酬・自己報酬] |
| **投資** | [ユーザーがサービスに蓄積する価値：データ・設定・人間関係・実績] |

### 4.7 ネットワーク効果とスイッチングコスト

[ユーザー増加に伴って体験価値が向上する仕組み。離脱すると失われる蓄積価値の設計。]

- **直接的ネットワーク効果**: [ユーザー同士の接続による価値向上]
- **間接的ネットワーク効果**: [補完サービス・コンテンツの充実]
- **データロックイン**: [使い続けるほど精度が上がるパーソナライゼーション]
- **コミュニティ帰属**: [ユーザーコミュニティによる帰属意識と離脱コスト]

### 4.8 ゲーミフィケーションと進捗の可視化

[体験価値の実感を増幅するゲーミフィケーション要素の設計。]
...
### 5.5 競合の強みに対するカウンター戦略

[競合の最も強い体験価値提供領域を特定し、それを無力化または上回るための具体的な戦略。]

| 競合の強み | カウンター戦略 | 実現可能性 |
|-----------|--------------|-----------|
| [競合Aの強み] | [無力化/上回る方法] | [高/中/低] |
| [競合Bの強み] | [無力化/上回る方法] | [高/中/低] |

### 5.6 競合の次の一手の予測と先回り戦略
...
[競争優位が時間の経過とともにどのように強化されるか。ネットワーク効果・データ蓄積・ブランド構築等による参入障壁の成長計画。]
...
- 元プロンプト（詳細確認用）: `workflows/business-planning/it-proposal.md`
